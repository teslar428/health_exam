...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "P6tZFIPsxLs5J7k-kUgk2zSqzWQyl-IKPkvyHbf7";
    private static final String SECRETKEY = "ZR8WXoq-pMy6o4MznfeF0M1gR2dPURMLjsKcRFVF";
    private static final String BUCKET = "teslar428";
    public static final String DOMAIN= "http://pu5b4vgmq.bkt.clouddn.com/";
